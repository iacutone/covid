defmodule Covid.WorkersTest do
  use Covid.DataCase
  ...
  describe "workers" do
    ...
    @valid_attrs %{current: true, name: "some name"}
    @update_attrs %{current: false, name: "some updated name"}
    @invalid_attrs %{current: nil, name: nil}
